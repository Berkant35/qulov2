const zhTranslations = <String, String>{
  ...
  'visibility_visible_title': '你的资料目前可见',
  'visibility_language_note': '你只能触达读得懂你问题所用语言的人。用你身边常说的语言写 2 个问题，能看到你的人就会不一样。',
  'visibility_checklist_title': '你的资料目前不可见',
  'visibility_checklist_intro': '这些完成之后，资料才会进入别人的发现：',
  'visibility_gate_location': '位置未开启',
  'visibility_gate_questions': '问题不足 2 个',
  'visibility_gate_photo': '还没有照片',
  ...
  'reason_power_used': '使用能力',
  'reason_power_reward': '能力奖励',
  'reason_question_reward': '问题奖励',
  'reason_power_purchase': '购买能力',
  'reason_iap': '购买',
  'reason_referral': '邀请奖励',
  'reason_subscription': '订阅奖励',
  'reason_boost': '加速',
  'reason_profile_completion': '完善资料',
  'reason_badge': '徽章奖励',
