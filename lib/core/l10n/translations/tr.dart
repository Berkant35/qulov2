const trTranslations = <String, String>{
  ...
  'visibility_visible_title': 'Profilin görünür durumda',
  'visibility_language_note': 'Yalnızca sorularının yazıldığı dili okuyan kişilere ulaşıyorsun. Çevrende konuşulan bir dilde iki soru, seni kimin görebileceğini değiştirir.',
  'visibility_checklist_title': 'Profilin şu anda görünmüyor',
  'visibility_checklist_intro': 'Bir profil, ancak bunlar tamamlanınca başkalarının Keşfet listesine giriyor:',
  'visibility_gate_location': 'Konum kapalı',
  'visibility_gate_questions': '2’den az soru',
  'visibility_gate_photo': 'Henüz fotoğraf yok',
  ...
  'question_create_motto': 'Seni anlatan sorular sor \u2014 seni tanıyan biri bilebilsin',
  'question_answers_must_differ': 'Şıklar birbirinden farklı olmalı',
  'question_create_difficulty_tip': 'Çok zor sorular eşleşmeni engeller — tahmin edilebilir tut',
  ...
  'onboarding_questions_slide2_desc': 'Sana özel, kişisel sorular sor. "Favori yemeğim nedir?" gibi seni tanıyan birinin bilebileceği sorular en iyisi!',
  ...
  'onboarding_v2_page2_desc': '2-10 soru oluştur. Kişisel, eğlenceli ve seni tanıyan birinin bilebileceği sorular. Biri tüm sorularını bilirse — eşleşirsiniz!',
  ...
  'reason_power_used': 'Güç Kullanımı',
  'reason_power_reward': 'Güç Ödülü',
  'reason_question_reward': 'Soru Ödülü',
  'reason_power_purchase': 'Güç Satın Alma',
  'reason_iap': 'Satın Alma',
  'reason_referral': 'Davet Ödülü',
  'reason_subscription': 'Abonelik Bonusu',
  'reason_boost': 'Boost',
  'reason_profile_completion': 'Profil Tamamlama',
  'reason_badge': 'Rozet Ödülü',
  ...
  'time_hours_ago_other': '{count} saat önce',
  'time_days_ago_one': '{count} gün önce',
  'time_days_ago_other': '{count} gün önce',
  'time_minutes_short': '{n}dk',
  'time_hours_short': '{n}sa',
  'time_days_short': '{n}g',
  'option_count_one': '{count} şık',
  'option_count_other': '{count} şık',
  'notification_default_body': 'Yeni bildirim',
  'sub_price_period_month': '/ay',
};
