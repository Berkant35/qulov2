const enTranslations = <String, String>{
  ...
  'delete_reason_title': 'Before you go: why are you leaving?',
  'delete_reason_subtitle': '(optional) It helps us improve.',
  'delete_reason_found_someone': 'I found someone',
  'visibility_visible_title': 'Your profile is visible',
  'visibility_language_note': 'You only reach people who read the language your questions are written in. Two questions in a language spoken around you change who can see you.',
  'visibility_checklist_title': 'Your profile isn’t visible right now',
  'visibility_checklist_intro': 'A profile only enters other people’s Discover once these are done:',
  'visibility_gate_location': 'Location is off',
  'visibility_gate_questions': 'Fewer than 2 questions',
  'visibility_gate_photo': 'No photo yet',
  'delete_reason_few_matches': 'Not enough matches',
  'delete_reason_few_users_nearby': 'Not enough people nearby',
  'delete_reason_app_confusing': 'The app is confusing',
  'delete_reason_technical_issues': 'Technical problems',
  'delete_reason_privacy_concerns': 'Privacy concerns',
  'delete_reason_too_expensive': 'Too expensive',
  'delete_reason_taking_a_break': 'Just taking a break',
  'delete_reason_other': 'Other',
  'delete_reason_other_hint': 'Tell us more (optional)',
  'delete_reason_skip': 'Skip',
  'delete_reason_submit': 'Delete Account',
  ...
  'question_create_motto': 'Ask questions about yourself \u2014 ones someone who knows you can answer',
  'question_answers_must_differ': 'Answer options must all be different',
  'question_create_difficulty_tip': 'Questions that are too hard stop you from matching \u2014 keep them guessable',
  ...
  'chat_unmatch_occurred': 'Match ended',
  ...
  'onboarding_questions_slide2_desc': 'Ask personal questions about you. Questions like "My favorite meal?" \u2014 the kind someone who knows you could answer!',
  ...
  'onboarding_v2_page2_desc': 'Create 2-10 questions. Personal, fun, and answerable by someone who knows you. If someone gets them all right — you match!',
  ...
  'reason_question_reward': 'Question Reward',
  'reason_power_purchase': 'Power Purchase',
  'reason_iap': 'Purchase',
  'reason_referral': 'Referral Bonus',
  'reason_subscription': 'Subscription Bonus',
  'reason_boost': 'Boost',
  'reason_profile_completion': 'Profile Completion',
  'reason_badge': 'Badge Reward',
  ...
  'setup_hint': 'In a hurry? Tap "Pick For Me"',
  ...
  'setup_question_magic_cta': 'Let AI Prepare',
  'setup_question_quick_cta': 'Pick For Me',
  'setup_question_manual_cta': 'Write My Own',
  'setup_question_done': '2 questions ready',
  'setup_quick_assign_error': "Couldn't add questions, try again",
  ...
  'preview_sheet_assign_cta': 'Add These',
  ...
  'coach_quiz_power_skip': 'Mark Correct: counts this question as right',
  ...
  'notification_default_body': 'New notification',
  'sub_price_period_month': '/mo',
};
