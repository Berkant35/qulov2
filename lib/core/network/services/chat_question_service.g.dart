...
part of 'chat_question_service.dart';
...
class _ChatQuestionService implements ChatQuestionService {
  _ChatQuestionService(this._dio, {this.baseUrl, this.errorLogger});
