...
class _ExchangeService implements ExchangeService {
  ...
  Future<ConvertResponse> convert(Map<String, dynamic> data) async {
    ...
    _data.addAll(data);
    final _options = _setStreamType<ConvertResponse>(
    ...
    late ConvertResponse _value;
    try {
      _value = ConvertResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
  ...
  Future<BuyPowerResponse> buyPower(Map<String, dynamic> data) async {
    ...
    final _data = <String, dynamic>{};
    _data.addAll(data);
    final _options = _setStreamType<BuyPowerResponse>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/exchange/buy-power',
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late BuyPowerResponse _value;
    try {
      _value = BuyPowerResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  Future<RatesResponse> getRates() async {
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<RatesResponse>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/exchange/rates',
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late RatesResponse _value;
    try {
      _value = RatesResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
