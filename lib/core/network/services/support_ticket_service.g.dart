...
part of 'support_ticket_service.dart';
...
class _SupportTicketService implements SupportTicketService {
  _SupportTicketService(this._dio, {this.baseUrl, this.errorLogger});
