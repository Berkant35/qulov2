...
class _QuizService implements QuizService {
  ...
  Future<QuizStartResponse> startSession(Map<String, dynamic> data) async {
    ...
    _data.addAll(data);
    final _options = _setStreamType<QuizStartResponse>(
    ...
    late QuizStartResponse _value;
    try {
      _value = QuizStartResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
  ...
  Future<QuizQuestionModel> getCurrentQuestion(String sessionId) async {
    ...
    final _options = _setStreamType<QuizQuestionModel>(
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late QuizQuestionModel _value;
    try {
      _value = QuizQuestionModel.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  Future<QuizResultModel> getSessionResult(String sessionId) async {
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<QuizResultModel>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
  ...
  Future<QuizSummaryModel?> getMatchQuizSummary(String matchId) async {
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<QuizSummaryModel>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/quiz/match/${matchId}/summary',
            queryParameters: queryParameters,
            data: _data,
          )
          .copyWith(baseUrl: _combineBaseUrls(_dio.options.baseUrl, baseUrl)),
    ...
    final _result = await _dio.fetch<Map<String, dynamic>?>(_options);
    late QuizSummaryModel? _value;
    try {
      _value = _result.data == null
          ? null
          : QuizSummaryModel.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
