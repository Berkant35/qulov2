...
UserModel _$UserModelFromJson(Map<String, dynamic> json) => UserModel(
  ...
  questionLocales: (json['question_locales'] as Map<String, dynamic>?)?.map(
  ...
  acquisitionAnswered: json['acquisition_answered'] as bool? ?? false,
  interests:
...
Map<String, dynamic> _$UserModelToJson(UserModel instance) => <String, dynamic>{
  ...
  'question_locales': instance.questionLocales,
  ...
  'acquisition_answered': instance.acquisitionAnswered,
